		...
		<div class="row">
			...
			<?php
				...
				while($row = mysqli_fetch_array($result)) {
					...
					echo '<div class="col-xs-12 col-md-4 box"><h2>Redatelj i glumci</h2><p>'.nl2br($row['postava']).'</p></div>';
					echo '<div class="col-xs-12 col-md-4 box"><h2>Sadržaj</h2><p>'.nl2br($row['sadrzaj']).'</p></div>';
			...
			<div class="col-xs-12 col-md-12 box "><a href="repertoar.php">Povratak na popis predstava</a></div>
		</div>
	</div>

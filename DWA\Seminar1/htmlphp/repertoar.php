...
<body>
				...
				<div class="col-md-6 col-xs-12">
					<nav class="main-navigation">
						<ul>
							...
							<li><a href="repertoar.php" style="color:#C1A4AF">Repertoar</a></li>
	...
	<div class="container-fluid">
		<div class="row">
			<div class="col-xs-12 col-md-12 title"><h1>Repertoar</h1></div>
			<?php 
				...
				while($row = mysqli_fetch_array($result)) {
					echo '<div class="col-xs-12 col-md-4 box imgInfo"><a href="predstavaInfo.php?id=' . $row['id'] . '"><h3>'.$row['naslov'].'</h3><img src="../images/'.$row['slika'].'" ></a>
					</div>';
				}
